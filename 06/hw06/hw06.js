...
// if(userGuess<(Math.random()*20)){
//     alert('Число замале, спробуйте ще раз');
// }
// else if(userGuess>(Math.random()*20)){
//     alert('Число завелике, спробуйте ще раз');
// }
// else{
//     alert('Вітаю! Ви ввели правильне число');
// }
// схоже, що я трохи щось наплутав, бо працює не дуже коректно і іноді дає хибну відповідь, підкажіть будь ласка, як я можу пофіксити код, щоб все запрацювало, як треба